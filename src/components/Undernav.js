...
function Undernav() {
    return (
        <div class= " bg-[#495e57] h-[340px] grid grid-cols-4 md:grid-cols-8 md:h-[420px] lg:grid-cols-12 lg:h-[700px]    ">
            ...
            <button class="h-[26px] w-[130px] bg-[#F4CE14] rounded-[50px] text-[14px] font-Inter lg:text-[40px] lg:h-[80px] lg:w-[400px] hover:bg-[#435334] md:h-[60px] md:w-[275px] md:text-[26px] ">Reserve Table Now</button>
            </div>
